...
run_simulation <- function(sim_num, save_results = TRUE) {
  ...
  # Run corHMM fits
  corhmm_fit_l0 <- corHMM:::corHMMDredge(phy = phy, data = cor_data, max.rate.cat = 2, pen.type = "l1", root.p = "maddfitz", lambda = 0, grad = TRUE, merge.params = TRUE)
  corhmm_fit_l1 <- corHMM:::corHMMDredge(phy = phy, data = cor_data, max.rate.cat = 2, pen.type = "l1", root.p = "maddfitz", lambda = 1, grad = TRUE, merge.params = TRUE)
  corhmm_fit_l2 <- corHMM:::corHMMDredge(phy = phy, data = cor_data, max.rate.cat = 2, pen.type = "l2", root.p = "maddfitz", lambda = 1, grad = TRUE, merge.params = TRUE)
  corhmm_fit_er <- corHMM:::corHMMDredge(phy = phy, data = cor_data, max.rate.cat = 2, pen.type = "er", root.p = "maddfitz", lambda = 1, grad = TRUE, merge.params = TRUE)
...
write.csv(average_results, "tables/structure_test_hmm_median.csv", row.names = FALSE)
