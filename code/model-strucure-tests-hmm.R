...
test_summ <- data.frame(
  l0=colSums(result_df_all[rownames(result_df_all) == "l0",], T)/100,
  l1=colSums(result_df_all[rownames(result_df_all) == "l1",], T)/100,
  l2=colSums(result_df_all[rownames(result_df_all) == "l2",], T)/100,
  er=colSums(result_df_all[rownames(result_df_all) == "er",], T)/100
)
